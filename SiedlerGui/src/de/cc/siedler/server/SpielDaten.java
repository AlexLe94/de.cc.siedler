...
public class SpielDaten implements Serializable {
	...
	// Verteilt die Rohstoffe auf die verschiedenen Spieler, entsprechend der gewürfelten Zahl
			...
			for (int i = 0; i<felder.size(); i++){
				for (int z = 0; z<felder.get(i).getEcken().size(); z++){
					...
					case "Siedlung - rot":{
						...
						case "Holz":{
							spielerListe.get(3).setiHolz(spielerListe.get(3).getiHolz()+1);
							break;
						}
						case "Erz":{
							spielerListe.get(3).setiErz(spielerListe.get(3).getiErz()+1);
							break;
						}
						case "Lehm":{
							spielerListe.get(3).setiLehm(spielerListe.get(3).getiLehm()+1);
							break;
						}
						case "Getreide":{
							spielerListe.get(3).setiGetreide(spielerListe.get(3).getiGetreide()+1);
							break;
						}
						case "Wolle":{
							spielerListe.get(3).setiWolle(spielerListe.get(3).getiWolle()+1);
							break;
						}
						default :
					...
					case "Siedlung - gruen":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(1).setiHolz(spielerListe.get(1).getiHolz()+1);
							break;
						}
						case "Erz":{
							spielerListe.get(1).setiErz(spielerListe.get(1).getiErz()+1);
							break;
						}
						case "Lehm":{
							spielerListe.get(1).setiLehm(spielerListe.get(1).getiLehm()+1);
							break;
						}
						case "Getreide":{
							spielerListe.get(1).setiGetreide(spielerListe.get(1).getiGetreide()+1);
							break;
						}
						case "Wolle":{
							spielerListe.get(1).setiWolle(spielerListe.get(1).getiWolle()+1);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Siedlung - blau":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(0).setiHolz(spielerListe.get(0).getiHolz()+1);
							break;
						}
						case "Erz":{
							spielerListe.get(0).setiErz(spielerListe.get(0).getiErz()+1);
							break;
						}
						case "Lehm":{
							spielerListe.get(0).setiLehm(spielerListe.get(0).getiLehm()+1);
							break;
						}
						case "Getreide":{
							spielerListe.get(0).setiGetreide(spielerListe.get(0).getiGetreide()+1);
							break;
						}
						case "Wolle":{
							spielerListe.get(0).setiWolle(spielerListe.get(0).getiWolle()+1);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Siedlung - orange":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(2).setiHolz(spielerListe.get(2).getiHolz()+1);
							break;
						}
						case "Erz":{
							spielerListe.get(2).setiErz(spielerListe.get(2).getiErz()+1);
							break;
						}
						case "Lehm":{
							spielerListe.get(2).setiLehm(spielerListe.get(2).getiLehm()+1);
							break;
						}
						case "Getreide":{
							spielerListe.get(2).setiGetreide(spielerListe.get(2).getiGetreide()+1);
							break;
						}
						case "Wolle":{
							spielerListe.get(2).setiWolle(spielerListe.get(2).getiWolle()+1);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Stadt - rot":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(3).setiHolz(spielerListe.get(3).getiHolz()+2);
							break;
						}
						case "Erz":{
							spielerListe.get(3).setiErz(spielerListe.get(3).getiErz()+2);
							break;
						}
						case "Lehm":{
							spielerListe.get(3).setiLehm(spielerListe.get(3).getiLehm()+2);
							break;
						}
						case "Getreide":{
							spielerListe.get(3).setiGetreide(spielerListe.get(3).getiGetreide()+2);
							break;
						}
						case "Wolle":{
							spielerListe.get(3).setiWolle(spielerListe.get(3).getiWolle()+2);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Stadt - gruen":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(1).setiHolz(spielerListe.get(1).getiHolz()+2);
							break;
						}
						case "Erz":{
							spielerListe.get(1).setiErz(spielerListe.get(1).getiErz()+2);
							break;
						}
						case "Lehm":{
							spielerListe.get(1).setiLehm(spielerListe.get(1).getiLehm()+2);
							break;
						}
						case "Getreide":{
							spielerListe.get(1).setiGetreide(spielerListe.get(1).getiGetreide()+2);
							break;
						}
						case "Wolle":{
							spielerListe.get(1).setiWolle(spielerListe.get(1).getiWolle()+2);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Stadt - blau":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(0).setiHolz(spielerListe.get(0).getiHolz()+2);
							break;
						}
						case "Erz":{
							spielerListe.get(0).setiErz(spielerListe.get(0).getiErz()+2);
							break;
						}
						case "Lehm":{
							spielerListe.get(0).setiLehm(spielerListe.get(0).getiLehm()+2);
							break;
						}
						case "Getreide":{
							spielerListe.get(0).setiGetreide(spielerListe.get(0).getiGetreide()+2);
							break;
						}
						case "Wolle":{
							spielerListe.get(0).setiWolle(spielerListe.get(0).getiWolle()+2);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
					...
					case "Stadt - orange":{
						switch(felder.get(i).getRohstoff()){
						case "Holz":{
							spielerListe.get(2).setiHolz(spielerListe.get(2).getiHolz()+2);
							break;
						}
						case "Erz":{
							spielerListe.get(2).setiErz(spielerListe.get(2).getiErz()+2);
							break;
						}
						case "Lehm":{
							spielerListe.get(2).setiLehm(spielerListe.get(2).getiLehm()+2);
							break;
						}
						case "Getreide":{
							spielerListe.get(2).setiGetreide(spielerListe.get(2).getiGetreide()+2);
							break;
						}
						case "Wolle":{
							spielerListe.get(2).setiWolle(spielerListe.get(2).getiWolle()+2);
							break;
						}
						default :
							Logger.info("Fehler bei Rohstoff oder Wüste");
	...
	// Felder auf dem Spielfeld mit Nummern von 2 bis 12 nummerieren, sodass später 
	...
	void feldNummerierung (){
		...
		for (int i=0; i<19; i++){										// Die Liste felder wird zufällig
			if (i==9){													// mit den verfügbaren Zahlen aus 
				felder.add(new Sechseck (0, ""));						// der Liste liFeldnummern gefüllt
			} else{
	...
	// eckPunkteListe mit möglichen Positionen zur Setzung von Siedlungen/Städten füllen	
	void initEckPunkteListe() {
			...
			for (int i = 0; i < 4; i++){					// dritte Reihe hinzufügen
				getEckPunkteListe().add(new Eckpunkte((x + i*difX), (y + difY), ""));	
				felder.get(i+3).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				if (i != 3){
					felder.get(i).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
				if (i == 1 || i == 2 || i == 3){
					felder.get(i-1).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
			}
			...
			for (int i = 0; i < 5; i++){					// fünfte Reihe hinzufügen
				getEckPunkteListe().add(new Eckpunkte((x + i*difX), (y + difY), ""));
				felder.get(i+7).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				if (i != 4){
					felder.get(i+3).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
				if (i == 1 || i == 2 || i == 3 || i == 4){
					felder.get(i+2).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
			}
			...
			for (int i = 0; i < 6; i++){					// siebte Reihe hinzufügen
				...
				if (i == 1 || i == 2 || i == 3 || i == 4 || i == 5){
					felder.get(i+6).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
					if (i != 5){
						felder.get(i+11).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
					}
				}
			}
			...
			for (int i = 0; i < 5; i++){					// achte Reihe hinzufügen
				...
				if (i == 1 || i == 2 || i == 3 || i == 4){
					felder.get(i+11).addEcke(new Eckpunkte((x + i*difX), y, ""));
				}
			}
			for (int i = 0; i < 5; i++){					// neunte Reihe hinzufügen
				getEckPunkteListe().add(new Eckpunkte((x + i*difX), (y + difY), ""));	
				if (i != 4){
					felder.get(i+12).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
				if (i == 1 || i == 2 || i == 3 || i == 4){
					felder.get(i+11).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
					if (i != 4){
						felder.get(i+15).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
					}
				}
			}
			...
			for (int i = 0; i < 4; i++){					// zehnte Reihe hinzufügen
				...
				felder.get(i+12).addEcke(new Eckpunkte((x + i*difX), y, ""));
				if (i != 3){
					felder.get(i+16).addEcke(new Eckpunkte((x + i*difX), y, ""));
				}
				if (i == 1 || i == 2 || i == 3){
					felder.get(i+15).addEcke(new Eckpunkte((x + i*difX), y, ""));
				}
			}
			for (int i = 0; i < 4; i++){					// elfte Reihe hinzufügen
				getEckPunkteListe().add(new Eckpunkte((x + i*difX), (y + difY), ""));		
				if (i != 3){
					felder.get(i+16).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
				if (i == 1 || i == 2 || i == 3){
					felder.get(i+15).addEcke(new Eckpunkte((x + i*difX), (y + difY), ""));
				}
	...
	void initSeitenListe() {
			...
			for (int i=0; i < getEckPunkteListe().size(); i++){
				if (i == 0 || i == 1 || i == 2 || i == 48 || i == 49){
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+3), ""));
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+4), ""));
					
				} else if (i == 3 || i == 4 || i == 5 || i == 6 || i == 42 || i == 43 | i == 44 || i == 45 || i == 46 || i == 47) {
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+4), ""));
					
				} else if (i == 7 || i == 8 || i == 9 || i == 10 || i == 39|| i == 40 || i == 41) {
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+4), ""));
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+5), ""));
					
				} else if (i == 11 || i == 12 || i == 13 || i == 14 || i == 15 || i == 32 
						|| i == 33 || i == 34 || i == 35 || i == 36 || i == 37 || i == 38){
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+5), ""));
					
				} else if (i == 16 || i == 17 || i == 18 || i == 19 || i == 20 || i == 28 || i == 29 || i == 30 || i == 31){
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+5), ""));
					getSeitenListe().add(new Seiten(getEckPunkteListe().get(i), getEckPunkteListe().get(i+6), ""));
